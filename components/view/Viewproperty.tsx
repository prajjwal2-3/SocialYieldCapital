         ...
         {property.properties[Number(viewId)-1].name}
          ...
          <section className="flex w-7/12 text-base font-medium text-L-Secondary">
            <p className="w-4/12 p-1  text-center flex">
              <Image src={bed} alt="" />
              <span className="mt-1">{property.properties[Number(viewId)-1].features.kitchen} Kitchens</span>
            </p>
            <p className="w-4/12 text-center p-1 flex ">
              <Image src={bed} alt="" />
              <span className="mt-1">{property.properties[Number(viewId)-1].features.bedroom} Bedrooms</span>
            </p>
            <div className="w-4/12  p-1 text-center flex">
              <Image src={bed} alt="" />
              <span className="mt-1">{property.properties[Number(viewId)-1].features.bathroom} Bathrooms</span>
            </div>
          </section>
          <div className="">
          ...
          {property.properties[Number(viewId)-1].amenities.map((e,index)=>
