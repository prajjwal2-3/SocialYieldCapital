...
<p className='font-semibold text-4xl md:w-4/12 w-8/12 text-white'>Take your investments
to the next level.</p>
<p className='font-medium text-xl md:w-7/12 w-8/12 text-D-Secondary'>Discover the exclusive benefits of our co-ownership model, designed to elevate your portfolio through premium property investments with accessible entry points.</p>
