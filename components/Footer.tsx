...
const Footer = () => {
  return (
    <>
    <div className="bg-Brand/Primary w-full flex-row h-auto py-6 md:h-fit justify-around  gap-5 flex px-24 text-center items-center">
<p className='font-semibold text-4xl  text-white'>Take your investments
to the next level.</p>

<section className=" justify-center items-center  flex gap-4 3xl:gap-8">
